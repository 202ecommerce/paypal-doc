...
![Étape 1 — connexion au compte PayPal Professionnel](assets/img/onboarding-1-connexion.png){ loading=lazy }
...
![Étape 1 — code du compte de connexion](assets/img/onboarding-1-code-compte.png){ loading=lazy }
...
- [Raccourcis ‘PayPal Express Checkout’](configuration.md#raccourcis-paypal-express-checkout)
- [Nom de marque](configuration.md#nom-de-marque)
- [Présenter les avantages PayPal à vos clients](configuration.md#presenter-les-avantages-paypal-a-vos-clients)
- [Mettre le bouton PayPal à la fin de la page de commande](configuration.md#mettre-le-bouton-paypal-a-la-fin-de-la-page-de-commande)
- [Bouton ‘Buy Now Pay Later\*’](configuration.md#bouton-buy-now-pay-later-proposez-le-paiement-en-plusieurs-fois-avec-paypal)
- [Messages ‘Buy Now Pay Later\*’](configuration.md#messages-buy-now-pay-later-faites-la-promotion-du-paiement-en-plusieurs-fois)
- [Personnalisez le statut de vos commandes](configuration.md#personnalisez-le-statut-de-vos-commandes)
- [Passer en mode restriction IP](configuration.md#passer-en-mode-restriction-ip)

![Étape 2 — configuration du checkout](assets/img/onboarding-2-checkout.png){ loading=lazy }
...
![Étape 3 — paiement en plusieurs fois](assets/img/onboarding-3-pay-later.png){ loading=lazy }
...
![Étape 4 — personnalisation des boutons de raccourci](assets/img/onboarding-4-boutons.png){ loading=lazy }

## Première connexion étape 5 : Configuration des statuts de commande et des webhooks

Il s’agit lors de cette étape de personnaliser les boutons de raccourci PayPal.

![Étape 5 — statuts de commande et webhooks](assets/img/onboarding-5-statuts.png){ loading=lazy }
...
![Étape 6 — restriction IP](assets/img/onboarding-6-restriction-ip.png){ loading=lazy }
